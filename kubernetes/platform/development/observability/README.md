Taken from Thomas Vitale's [Grafana Observability Stack Guide](https://github.com/ThomasVitale/cloud-native-spring-in-action/blob/main/Guides/grafana-observability-stack/README.md) 
<hr>
...
You can access the Grafana console via port-forwarding to your local machine:
